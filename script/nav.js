const showNavbar = () => {
    ...
    navbar.className = "fixed top-0 left-10 h-[90vh] z-30 hidden lg:block"
    navbar.setAttribute("id", "navbar");

    if (role != "admin" && role != "nakes") {
        navbar.innerHTML = `
            <div class="navbar p-4 my-10 bg-white w-64 h-full border-4 border-green-300 rounded-lg overflow-y-auto">
                <div class="border-b-4 border-green-300 pb-2">
                    <a href="./index.html">
                        <img src="../assets/svg/logo_samping.svg" alt="logo" class="h-20 w-auto duration-200">
                    </a>
                </div>
                <h5 class="text-base font-semibold text-gray-500 uppercase mt-4">Menu
                </h5>
                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="./discussion.html"
                                ...
                                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                    ...
                                    viewBox="0 0 20 18">
                                    <path
                                        d="M5 0C2.24 0 0 2.24 0 5v5c0 2.76 2.24 5 5 5h1v3l4-3h5c2.76 0 5-2.24 5-5V5c0-2.76-2.24-5-5-5H5zm10 2c1.66 0 3 1.34 3 3v5c0 1.66-1.34 3-3 3H9l-3 3v-3H5c-1.66 0-3-1.34-3-3V5c0-1.66 1.34-3 3-3h10z" />
                                </svg>
                        ...
                        <li>
                            ...
                            <ul id="dropdown-education" class="hidden py-2 space-y-2">
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-500">Unggah
                                        Konten Edukasi</a>
                                </li>
                            </ul>
                        </li>
...
const showFooter = () => {
    ...
    footer.className = "bg-gray-200 absolute w-screen z-40";
